...
const PROD_LIMIT = 300000; // Default number of records to fetch per sync
const TEST_LIMIT = 2000;   // Smaller limit for testing
export const syncRestaurants = async (limit =TEST_LIMIT ) => {
    const db = getdb();
